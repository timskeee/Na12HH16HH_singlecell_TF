...
class NeuronModel:
    def __init__(self,ais_nav16_fac, ais_nav12_fac, mod_dir ='../cells/Neuron_Model_12HH16HH/',#'./Neuron_Model_12HH16HH/',#'./Neuron_Model_HH/', 
        ...
        if update:
            ...
            # multiply_param(self,['SKv3_1'],'mtaumul',0.01) ## se
...
#Function for determining and plotting the distribution of Na channels in axon.
    ...
    def init_stim(self, sweep_len = 250, stim_start = 100, stim_dur = 200, amp = 0.3, dt = 0.1): ##TF071524 getting 1-3 APs for Roy
