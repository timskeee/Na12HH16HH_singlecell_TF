...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 6, 0);
 	...
 	ivoc_help("help ?1 ch_leak /workspaces/Na12HH16HH_singlecell/mod/ch_leak.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/workspaces/Na12HH16HH_singlecell/mod/ch_leak.mod";
static const char* nmodl_file_text = 
