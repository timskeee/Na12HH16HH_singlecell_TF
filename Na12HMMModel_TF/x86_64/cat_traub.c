...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 catt /ddn/mleitner8/Channelopathies_2024/sim/mod/cat_traub.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ddn/mleitner8/Channelopathies_2024/sim/mod/cat_traub.mod";
static const char* nmodl_file_text = 
