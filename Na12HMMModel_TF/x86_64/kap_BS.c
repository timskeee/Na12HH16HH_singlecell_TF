...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kap /ddn/mleitner8/Channelopathies_2024/sim/mod/kap_BS.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ddn/mleitner8/Channelopathies_2024/sim/mod/kap_BS.mod";
static const char* nmodl_file_text = 
