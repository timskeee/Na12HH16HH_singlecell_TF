...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 IKsin /ddn/mleitner8/Channelopathies_2024/sim/mod/IKsin.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ddn/mleitner8/Channelopathies_2024/sim/mod/IKsin.mod";
static const char* nmodl_file_text = 
