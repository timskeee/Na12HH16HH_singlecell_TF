...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "pointer");
 	...
 	ivoc_help("help ?1 Dipole /ddn/mleitner8/Channelopathies_2024/sim/mod/dipole_pp.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ddn/mleitner8/Channelopathies_2024/sim/mod/dipole_pp.mod";
static const char* nmodl_file_text = 
